...
<html>
    ...
    <body>
        ...
        <div id="show-farmer" class="content scaffold-show" role="main">
            ...
            <f:display bean="farmer" />
            <g:form resource="${this.farmer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.farmer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
