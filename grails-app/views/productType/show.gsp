...
<html>
    ...
    <body>
        ...
        <div id="show-productType" class="content scaffold-show" role="main">
            ...
            <f:display bean="productType" />
            <g:form resource="${this.productType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.productType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
